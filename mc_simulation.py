#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Conflict Minerals / Fungibility Floor
=====================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Conflict Minerals (Fungibility Floor).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "conflict_minerals",
    "domain_name": "Conflict Minerals",
    "theorem": "Fungibility Floor",
    "classification": "Class 1 \u2014 Impossibility",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 20.3,
    "channels": {
        "C1_armed_conflict": {
            "dist": "lognormal",
            "low": 50,
            ...
            "high": 130,
            "weight": 0.3,
            "description": "Armed conflict financing, displacement, death"
        },
        "C2_health_mortality": {
            "dist": "lognormal",
            "low": 25,
            ...
            "high": 65,
            "weight": 0.2,
            "description": "Occupational mortality, toxic exposure, disease"
        },
        "C3_environmental": {
            "dist": "lognormal",
            "low": 20,
            ...
            "high": 55,
            "weight": 0.15,
            "description": "Deforestation, water contamination, biodiversity loss"
        },
        "C4_forced_labor": {
            "dist": "lognormal",
            "low": 18,
            ...
            "high": 50,
            "weight": 0.15,
            "description": "Child labor, forced labor in artisanal mining"
        },
        "C5_governance": {
            "dist": "lognormal",
            "low": 15,
            ...
            "high": 45,
            "weight": 0.1,
            "description": "Governance failure, warlord economies, corruption"
        },
        "C6_compliance": {
            "dist": "normal",
            "low": 25,
            ...
            "high": 52,
            "weight": 0.1,
            "description": "Downstream compliance deadweight, audit costs"
        }
    },
